...
class Producer(object):
    ...
    rabbit_url = "http://localhost"

    def __init__(self, exchange):
        self._rabbit_url = self.rabbit_url
...
class Consumer(object):
    ...
    def _setup_queue(self, queue_name):
        self._channel.queue_declare(self._on_queue_declareok, queue_name, auto_delete=True)
...
class Listener(Consumer):
    ...
    def __init__(self, rabbit_url="http://localhost"):
